...
const { COINBASE_URL } = require('../../../config.json').coinbase[env]
const { COINBASE_CLIENT_ID } = require('../../../config.json').coinbase[env]
const { COINBASE_CLIENT_SECRET } = require('../../../config.json').coinbase[env]
const { COINBASE_CALLBACK_URL } = require('../../../config.json').coinbase[env]
