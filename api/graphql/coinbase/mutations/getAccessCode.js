...
const COINBASE_URL = require('../../../config.json').coinbase[env].COINBASE_URL;
const COINBASE_CLIENT_ID = require('../../../config.json').coinbase[env].COINBASE_CLIENT_ID;
const COINBASE_CLIENT_SECRET = require('../../../config.json').coinbase[env].COINBASE_CLIENT_SECRET;
const COINBASE_CALLBACK_URL = require('../../../config.json').coinbase[env].COINBASE_CALLBACK_URL;
